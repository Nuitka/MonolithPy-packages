...
Instrumented: faulthandler + flushed per-import / per-test markers so that a
hard crash (0xC000001D etc.) in the relinked interpreter reveals the exact
import or test function that faults, plus a C-level traceback, in the CI log.
The original test bodies are unchanged.
"""
...
_mark("MARK: import numpy")
import numpy as np
_mark("MARK: import statsmodels.api")
import statsmodels.api as sm
_mark("MARK: import statsmodels.tsa.stattools")
from statsmodels.tsa.stattools import adfuller, acf, pacf
_mark("MARK: import statsmodels.stats.diagnostic")
from statsmodels.stats.diagnostic import het_breuschpagan
_mark("MARK: import statsmodels.stats.stattools")
from statsmodels.stats.stattools import durbin_watson
_mark("MARK: imports complete")
...
if __name__ == "__main__":
    for _name in [
        ...
        _mark("MARK: running " + _name)
        globals()[_name]()
    _mark("All statsmodels tests passed!")
