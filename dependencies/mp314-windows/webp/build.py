...
def run(wheel_directory):
    ...
    result_wheel = os.path.join(wheel_directory, __mp__.get_wheel_name("mpy_dep_webp", "1.5.0"))
    with WheelFile(result_wheel, 'w') as w:
        __mp__.add_wheel_manifest(w, "mpy-dep-webp", "1.5.0")
        __mp__.add_wheel_dep_libs(w, "webp", os.path.join(install_dir, "lib", "*"))
        __mp__.add_wheel_dep_include(w, "webp", os.path.join(install_dir, "include", "**", "*.h"),
